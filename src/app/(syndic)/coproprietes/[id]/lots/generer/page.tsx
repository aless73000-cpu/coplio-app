        ...
        <div className="coplio-card">
          <div className="flex items-center gap-2 mb-5">
            <div className="w-8 h-8 bg-coplio-green-light rounded-lg flex items-center justify-center">
              <Wand2 className="w-4 h-4 text-coplio-green" />
            </div>
          ...
          <button
            ...
            className="mt-5 w-full flex items-center justify-center gap-2 bg-coplio-green text-white font-medium py-2.5 rounded-lg hover:bg-coplio-green/90 transition-colors text-sm"
          >
          ...
          <div className="coplio-card animate-fade-in">
            ...
            <div className="overflow-x-auto max-h-96 overflow-y-auto rounded-lg border border-border">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {preview.map((lot, i) => (
                    <tr key={i} className={`border-b border-border transition-colors ${editingIndex === i ? 'bg-coplio-green-light/30' : 'hover:bg-coplio-bg'}`}>
                      {editingIndex === i ? (
                        <>
                          <td className="py-1.5 px-3">
                            <input
                              ...
                              className="w-20 px-2 py-1 text-xs border border-coplio-green/50 rounded focus:outline-none focus:ring-1 focus:ring-coplio-green"
                            />
                          </td>
                          <td className="py-1.5 px-3">
                            <select
                              ...
                              className="text-xs border border-coplio-green/50 rounded px-1.5 py-1 focus:outline-none focus:ring-1 focus:ring-coplio-green"
                            >
                              {LOT_TYPES.map((t) => (
                                <option key={t} value={t}>{LOT_TYPE_LABELS[t]}</option>
                              ))}
