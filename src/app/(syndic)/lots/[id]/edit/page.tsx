      ...
      <div className="flex gap-3 mt-5">
        ...
        <div className="flex-1 flex gap-3">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-coplio-green text-white font-medium py-2.5 px-4 rounded-lg hover:bg-coplio-green/90 transition-colors disabled:opacity-50 text-sm"
          >
