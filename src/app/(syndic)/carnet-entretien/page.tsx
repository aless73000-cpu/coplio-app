...
function Modal({ open, onClose, onSave, coproprietes, prestataires, initial }: {
  ...
  const inputCls = "w-full px-3 py-2.5 text-sm border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#374151]/20 bg-white"
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button type="submit" disabled={saving}
              className="flex items-center gap-2 px-4 py-2 text-sm bg-[#374151] text-white rounded-lg hover:bg-[#374151]/90 disabled:opacity-60">
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex gap-3 flex-wrap">
        <select value={filterStatut} onChange={e => setFilterStatut(e.target.value)}
          className="px-3 py-2 text-sm border border-border rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-[#374151]/20">
      ...
      {loading ? (
        ...
        <div className="coplio-card text-center py-16">
          <div className="w-14 h-14 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-3">
            <BookOpen className="w-7 h-7 text-[#374151]" />
          </div>
            ...
            <div key={e.id} className="coplio-card">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5">
                  <Wrench className="w-5 h-5 text-[#374151]" />
                </div>
                ...
                <div className="flex gap-1 flex-shrink-0">
                  <button onClick={() => handleEdit(e)}
                    className="p-1.5 hover:bg-coplio-bg rounded-lg transition-colors text-muted-foreground hover:text-[#374151]" title="Modifier">
