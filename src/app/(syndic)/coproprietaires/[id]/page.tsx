    ...
    <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
              soldeTotalDu > 0 ? 'bg-red-100' : 'bg-[#374151]/20'
            }`}>
              <CreditCard className={`w-5 h-5 ${soldeTotalDu > 0 ? 'text-red-500' : 'text-[#374151]'}`} />
            </div>
            <div>
              <p className="text-xs text-muted-foreground font-medium uppercase tracking-wide">Solde dû</p>
              <p className={`text-2xl font-bold ${soldeTotalDu > 0 ? 'text-red-600' : 'text-[#374151]'}`}>
      ...
      <div className="coplio-card">
        <div className="flex items-center gap-3 mb-5">
          <div className="w-14 h-14 bg-[#374151]/10 rounded-full flex items-center justify-center flex-shrink-0">
            <User className="w-7 h-7 text-[#374151]" />
          </div>
          <div className="flex-1">
          ...
          {copropriétaire.profile_id && (
            <Link
              ...
              className="flex items-center gap-2 text-sm font-medium text-[#374151] border border-[#374151]/30 px-3 py-2 rounded-lg hover:bg-slate-100 transition-colors"
            >
        ...
        <dl className="space-y-3 text-sm">
          {copropriétaire.email && (
            <div className="flex items-center gap-2">
              ...
              <a href={`mailto:${copropriétaire.email}`} className="text-[#374151] hover:underline">
                {copropriétaire.email}
              </a>
            </div>
          )}
          {copropriétaire.telephone && (
            <div className="flex items-center gap-2">
              ...
              <a href={`tel:${copropriétaire.telephone}`} className="text-coplio-text hover:text-[#374151]">
                {copropriétaire.telephone}
              </a>
            </div>
          )}
              ...
              return (
                ...
                >
                  <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${
                    appel.paye ? 'bg-[#374151]/10' : isLate ? 'bg-red-100' : 'bg-amber-50'
                  }`}>
                    {appel.paye
                  ...
                  <div className="text-right flex-shrink-0">
                    <p className={`text-sm font-semibold ${
                      appel.paye ? 'text-[#374151]' : isLate ? 'text-red-600' : 'text-coplio-text'
                    }`}>
          ...
          <div className="space-y-3">
            {lots.map((cl) => {
              ...
              return (
                ...
                >
                  <div className="w-9 h-9 bg-[#374151]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="text-right flex-shrink-0">
                    ...
                    {(lot.solde_compte ?? 0) !== 0 && (
                      <p className={`text-xs font-medium ${(lot.solde_compte ?? 0) < 0 ? 'text-red-500' : 'text-[#374151]'}`}>
