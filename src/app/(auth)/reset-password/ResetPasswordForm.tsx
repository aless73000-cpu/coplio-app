      ...
      <div className="w-full max-w-md">
        ...
        {done ? (
          <div className="coplio-card text-center py-10">
            <CheckCircle2 className="w-14 h-14 text-coplio-green mx-auto mb-4" />
          ...
          <div className="coplio-card">
            <div className="mb-6">
              <div className="w-12 h-12 bg-coplio-green-light rounded-2xl flex items-center justify-center mb-4">
                <KeyRound className="w-6 h-6 text-coplio-green" />
              </div>
            ...
            <p className="text-center text-xs text-muted-foreground mt-4">
              Lien expiré ?{' '}
              <Link href="/forgot-password" className="text-coplio-green hover:underline">
