  ...
  return (
    <div className="min-h-screen bg-coplio-bg flex flex-col items-center justify-center px-5 py-10">
      ...
      <div className="w-full max-w-sm">
        ...
        {/* Header vert */}
        <div className="bg-[#374151] rounded-2xl px-6 pt-8 pb-6 mb-4 text-white text-center relative overflow-hidden">
        ...
        <div className="bg-white rounded-2xl border border-border px-6 py-6 mb-4">
          ...
          {searchParams.message && (
            <div className="mb-4 p-3 bg-slate-100 border border-[#374151]/20 rounded-xl">
              <p className="text-[#374151] text-sm">{searchParams.message}</p>
            </div>
          )}
        ...
        <p className="text-center text-xs text-muted-foreground">
          Vous êtes syndic ?{' '}
          <Link href="/login" className="text-[#374151] font-medium hover:underline">
