        ...
        <div className="coplio-card prose prose-sm max-w-none">
          ...
          <section className="mb-6">
            ...
            <ul className="text-sm text-coplio-text leading-relaxed mt-2 space-y-1">
              ...
              <li><strong>Email :</strong> <a href="mailto:contact@coplio.fr" className="text-coplio-green hover:underline">contact@coplio.fr</a></li>
            </ul>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-sm text-coplio-text leading-relaxed">
              ...
              Pour tout contact : <a href="mailto:contact@coplio.fr" className="text-coplio-green hover:underline">contact@coplio.fr</a>
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <ul className="text-sm text-coplio-text leading-relaxed mt-2 space-y-1">
              ...
              <li><a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="text-coplio-green hover:underline">vercel.com</a></li>
            </ul>
            ...
            <ul className="text-sm text-coplio-text leading-relaxed mt-2 space-y-1">
              ...
              <li><a href="https://supabase.com" target="_blank" rel="noopener noreferrer" className="text-coplio-green hover:underline">supabase.com</a></li>
            </ul>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-sm text-coplio-text leading-relaxed mt-2">
              Pour exercer ces droits ou pour toute question relative au traitement de vos données, contactez-nous à <a href="mailto:contact@coplio.fr" className="text-coplio-green hover:underline">contact@coplio.fr</a>.
            </p>
            <p className="text-sm text-coplio-text leading-relaxed mt-2">
              Pour plus d&apos;informations, consultez notre <Link href="/confidentialite" className="text-coplio-green hover:underline">politique de confidentialité</Link>.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-sm text-coplio-text leading-relaxed">
              ...
              <a href="mailto:contact@coplio.fr" className="text-coplio-green hover:underline">contact@coplio.fr</a>
            </p>
          </section>
        </div>
      </div>
