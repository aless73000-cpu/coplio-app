      ...
      <div className="flex gap-2 mb-5">
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
            tab === 'support' ? 'bg-coplio-green text-white' : 'bg-white text-coplio-text hover:bg-coplio-bg border border-border'
          }`}
        >
          Support clients
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
            tab === 'interne' ? 'bg-coplio-green text-white' : 'bg-white text-coplio-text hover:bg-coplio-bg border border-border'
          }`}
        >
          Chat interne
        </button>
      ...
      <div className="coplio-card flex flex-col" style={{ height: '520px' }}>
          ...
          <div className="pb-3 mb-3 border-b border-border flex-shrink-0">
            {cabinets.length === 0 ? (
              ...
              <select
                ...
                className="w-full px-3 py-2 text-sm bg-coplio-bg border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-coplio-green"
              >
                {cabinets.map(c => (
        ...
        <div className="flex gap-2 pt-3 mt-3 border-t border-border flex-shrink-0">
          <input
            ...
            className="flex-1 px-3 py-2.5 text-sm bg-coplio-bg border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-coplio-green"
          />
          <button
            onClick={send}
            disabled={sending || !input.trim()}
            className="bg-coplio-green text-white p-2.5 rounded-lg hover:bg-coplio-green/90 transition-colors disabled:opacity-60"
          >
