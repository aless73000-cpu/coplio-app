  ...
  const FEATURES_DATA = [
    {
      ...
      Preview: function DashboardPreview() {
        return (
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-2">
              {([{v:'12',l:'Copropriétés',c:'text-[#0F6E56]',bg:'bg-[#E1F5EE]'},{v:'284',l:'Lots gérés',c:'text-blue-600',bg:'bg-blue-50'},{v:'3',l:'Sinistres',c:'text-amber-600',bg:'bg-amber-50'},{v:'1.4k€',l:'Impayés',c:'text-red-500',bg:'bg-red-50'}] as const).map(({v,l,c,bg})=>(
    ...
    },
    {
      ...
      Preview: function CoproprietePreview() {
        return (
    ...
    },
    {
      ...
      Preview: function CoproprietairesPreview() {
        return (
          <div className="space-y-3">
    ...
    },
    {
      ...
      Preview: function ChargesPreview() {
        return (
    ...
    },
    {
      ...
      Preview: function DocumentsPreview() {
        return (
          <div className="space-y-2">
            {([
    ...
    },
    {
      ...
      Preview: function SinistresPreview() {
        return (
    ...
    },
    {
      ...
      Preview: function MessageriePreview() {
        return (
          <div className="space-y-2.5">
