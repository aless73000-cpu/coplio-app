  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  {doc.signedUrl && (
                    <a
                      ...
                      className="flex items-center gap-1.5 text-xs font-medium text-coplio-green bg-coplio-green-light hover:bg-coplio-green hover:text-white px-2.5 py-1 rounded-full transition-colors"
                    >
      ...
      {(assemblees ?? []).length > 0 && (
        <div>
          <div className="flex items-center gap-2 mb-3">
            <Calendar className="w-4 h-4 text-coplio-green" />
            <h2 className="font-semibold text-coplio-text text-sm uppercase tracking-wide">
      ...
      {profile?.lot_id && asSigned.length === 0 && (assemblees ?? []).length === 0 && reglements.length === 0 && (
        <div className="coplio-card text-center py-16">
          ...
          <Link
            href="/mes-assemblees"
            className="inline-flex items-center gap-1.5 mt-4 text-sm font-medium text-coplio-green hover:underline"
          >
