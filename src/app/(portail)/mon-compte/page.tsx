...
export default async function MonComptePage({
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 py-4">
      ...
      {/* Save confirmation */}
      {saved && (
        <div className="flex items-center gap-3 p-4 bg-slate-100 border border-[#374151]/20 rounded-xl">
          <CheckCircle2 className="w-5 h-5 text-[#374151] flex-shrink-0" />
          <p className="text-sm font-medium text-[#374151]">Vos informations ont été mises à jour.</p>
        </div>
      )}
      ...
      <div className="bg-white rounded-2xl border border-border shadow-sm overflow-hidden">
        ...
        <div className="px-4 py-3.5 border-b border-border flex items-center gap-3">
          ...
          <span className="ml-auto inline-flex items-center gap-1.5 text-xs font-medium px-2.5 py-1 rounded-full bg-slate-100 text-[#374151]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2.5 bg-coplio-bg border border-border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#374151]/20 focus:border-transparent"
              />
            </div>
            <div>
              <label className="block text-xs font-medium text-muted-foreground uppercase tracking-wide mb-1.5">
                ...
                <div className="bg-coplio-bg rounded-xl p-3 flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <a
                      ...
                      className="text-sm font-medium text-coplio-text hover:text-[#374151] transition-colors truncate block"
                    >
                      {lot.copropriete.cabinet.email_contact}
                    </a>
                  </div>
                ...
                <div className="bg-coplio-bg rounded-xl p-3 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-sm font-medium text-coplio-text hover:text-[#374151] transition-colors"
                    >
                      {lot.copropriete.cabinet.telephone}
                    </a>
                  </div>
      ...
      <div className="bg-white rounded-2xl border border-border shadow-sm overflow-hidden">
        ...
        <div className="p-5">
          {pwdSaved && (
            <div className="flex items-center gap-3 p-3 bg-slate-100 border border-[#374151]/20 rounded-xl mb-4">
              <CheckCircle2 className="w-4 h-4 text-[#374151] flex-shrink-0" />
              <p className="text-sm font-medium text-[#374151]">Mot de passe mis à jour avec succès.</p>
            </div>
          )}
          {pwdError && (
