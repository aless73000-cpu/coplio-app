...
export function AddonPortailButton() {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="flex items-center gap-2 bg-[#374151] text-white text-sm font-medium px-4 py-2 rounded-xl hover:bg-[#374151]/90 transition-colors disabled:opacity-60"
    >
      {loading ? (
