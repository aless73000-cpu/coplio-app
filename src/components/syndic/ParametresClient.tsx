...
import { User, Building2, Bell, Loader2, CheckCircle2, Users, ChevronRight, Upload, BellRing, FileUp, History, RefreshCw, ChevronLeft, ShieldCheck, ShieldOff, KeyRound, Wrench, BookOpen, LayoutDashboard, SlidersHorizontal } from 'lucide-react'
...
function DashboardPrefsSection({ userId: _userId }: { userId: string }) {
  return (
    <section className="coplio-card">
