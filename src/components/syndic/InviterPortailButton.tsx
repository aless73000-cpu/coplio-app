...
export function InviterPortailButton({
  ...
  if (status === 'success') {
    return (
      <div className="flex items-center gap-2 px-4 py-2.5 bg-coplio-green-light rounded-lg text-sm text-coplio-green font-medium">
  ...
  return (
    <div className="space-y-2">
      <button
        ...
        className="flex items-center gap-2 px-4 py-2.5 bg-coplio-green text-white rounded-lg text-sm font-medium
