    ...
    <section id="tarifs" className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-12">
          <span className="text-[11px] font-bold text-[#374151] uppercase tracking-[0.18em]">Tarifs</span>
        ...
        <div className="flex items-center justify-center gap-3 bg-gradient-to-r from-[#F1F5F9] to-[#F5F5F7] border border-[#374151]/15 rounded-2xl p-4 mb-10">
          <Zap className="w-4 h-4 text-[#374151] flex-shrink-0" />
            ...
            <div
              ...
              className={`relative rounded-3xl p-8 border-2 flex flex-col transition-all duration-300 ${
                highlight
                  ...
                  : 'border-gray-100 bg-white hover:border-[#374151]/30 hover:shadow-lg'
              }`}
            >
              {badge && (
