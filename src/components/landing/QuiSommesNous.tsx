      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-[#111827] mb-6" style={{ letterSpacing: '-0.03em', lineHeight: 1.1 }}>
            ...
            <div className="space-y-3">
              {['Fondé en France, pour le marché français', 'Données hébergées en Europe (RGPD)', 'Support disponible par messagerie', 'Mises à jour basées sur vos retours'].map((item) => (
                <div key={item} className="flex items-center gap-3">
                  <div className="w-5 h-5 bg-[#111827] rounded-full flex items-center justify-center flex-shrink-0">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2 bg-[#111827] rounded-3xl p-8">
            ...
            <div className="bg-white rounded-3xl p-6 border border-slate-100">
              <div className="text-4xl font-bold text-[#111827] mb-1" style={{ letterSpacing: '-0.03em' }}>2025</div>
              <div className="text-sm text-slate-400">Année de création</div>
            </div>
            <div className="bg-white rounded-3xl p-6 border border-slate-100">
              <div className="text-4xl font-bold text-[#111827] mb-1" style={{ letterSpacing: '-0.03em' }}>100 %</div>
